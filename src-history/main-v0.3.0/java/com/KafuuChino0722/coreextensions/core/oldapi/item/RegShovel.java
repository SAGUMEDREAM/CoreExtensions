...
public class RegShovel {
    ...
    public static void load() {
        ...
        try {
            Map<String, Map<String, Object>> ValueData = yaml.load(new FileReader(FILE +"shovel.yml"));

            if (ValueData != null && ValueData.containsKey("shovels")) {
                Map<String, Object> swords = ValueData.get("shovels");
                ...
                for (Map.Entry<String, Object> entry : swords.entrySet()) {
                    if (entry.getValue() instanceof Map) {
                        ...
                        ToolItem shovel = register(namespace, id, (double) attackDamage, (float) attackSpeed, durability, (ToolMaterials) material);
                    }
                }
            }
        } catch (IOException e) {
