...
import com.KafuuChino0722.coreextensions.item.CustomShovelItem;
...
public class Shovel {
    ...
    public static void register(String name, String namespace, String id, Map<String, Object> itemData, Map<String, Object> properties, String level, boolean generate){
        ...
        ToolItem Shovel = new CustomShovelItem(material, (int) attackDamage, (float) attackSpeed, new FabricItemSettings().maxDamage(durability).rarity(rarityType), tooltipMsg);
    ...
    public static ToolItem registerShovel(String namespace, String id, double attackDamage, float attackSpeed, int durability, ToolMaterials material, Rarity rarityType, String tooltipMsg) {
        return Registry.register(Registries.ITEM, new Identifier(namespace, id),
                new CustomShovelItem(material, (float) attackDamage, attackSpeed, new FabricItemSettings().maxDamage(durability).rarity(rarityType), tooltipMsg));
    }
}
