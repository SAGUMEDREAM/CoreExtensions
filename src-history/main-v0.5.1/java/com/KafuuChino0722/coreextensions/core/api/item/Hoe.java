...
public class Hoe {
    ...
    public static void register(String name, String namespace, String id, Map<String, Object> itemData, Map<String, Object> properties, String level, boolean generate){
        ...
        ToolItem Hoe = new CustomHoeItem(material, (int) attackDamage, (float) attackSpeed, new FabricItemSettings().maxDamage(durability).rarity(rarityType), tooltipMsg);

        try {
            registerItem(namespace, id, Hoe);
        } catch (Exception e) {
            setRegistry.set(namespace,id,Hoe);
        }
