...
public class Shears {
    ...
    public static void register(String name, String namespace, String id, Map<String, Object> itemData, Map<String, Object> properties, String level, boolean generate){
        ...
        ShearsItem Shears = new CustomShearsItem(new FabricItemSettings().maxDamage(durability).rarity(rarityType), tooltipMsg);

        try {
            registerItem(namespace, id, Shears);
        } catch (Exception e) {
            setRegistry.set(namespace,id,Shears);
        }
