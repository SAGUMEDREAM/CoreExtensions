...
public class CropBlocks6
        extends PlantBlock
        implements Fertilizable {
    public static final int MAX_AGE = 6;
    public static final IntProperty AGE = Int.AGE_6;
    ...
    public CropBlocks6(Settings settings, String namespace, String id) {
        super(settings);
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        float f;
        int i;
        if (world.getBaseLightLevel(pos, 0) >= 9 && (i = this.getAge(state)) < this.getMaxAge() && random.nextInt((int)(25.0f / (f = CropBlocks6.getAvailableMoisture(this, world, pos))) + 1) == 0) {
