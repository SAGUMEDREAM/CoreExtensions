...
public class BlockManager {
    ...
    public static final Block FLOWER_PEAONIA = registerBlock("flower_paeonia",
            new FlowerBlock(StatusEffects.NIGHT_VISION, 5, AbstractBlock.Settings.create()
    ...
    public static void load() {
        ...
        if(Reference.EnvType == EnvType.CLIENT) {
            ...
            setupRenderLayer.set(FLOWER_PEAONIA);
        }
    }
}
