...
import com.KafuuChino0722.coreextensions.mixin.CommandManagerMixin;
...
public class Main implements ModInitializer {
	...
	public void onInitialize() {
		...
		LOGGER.info("CoreExtensions Loaded!");
		LOGGER.info("CoreExtensions Mixin Loaded!");
		CommandManager.load();
		CoreManager.load();
		...
		if (firstShellEnabled) {
			LOGGER.info("CoreExtensions First Loaded!");
			LOGGER.info("Generating example configuration file!");
			FirstShell.load();
		}
