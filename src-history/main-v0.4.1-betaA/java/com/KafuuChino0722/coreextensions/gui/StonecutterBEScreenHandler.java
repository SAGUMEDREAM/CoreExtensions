package com.KafuuChino0722.coreextensions.gui;
...
public class StonecutterBEScreenHandler extends ScreenHandler {
    ...
    public StonecutterBEScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
    }

    public StonecutterBEScreenHandler(int syncId, PlayerInventory playerInventory, final ScreenHandlerContext context) {
        ...
        this.input = new SimpleInventory(1) {
            public void markDirty() {
                super.markDirty();
                StonecutterBEScreenHandler.this.onContentChanged(this);
                StonecutterBEScreenHandler.this.contentsChangedListener.run();
            }
        };
        ...
        this.outputSlot = this.addSlot(new Slot(this.output, 1, 143, 33) {
            ...
            public void onTakeItem(PlayerEntity player, ItemStack stack) {
                ...
                StonecutterBEScreenHandler.this.output.unlockLastRecipe(player, this.getInputStacks());
                ItemStack itemStack = StonecutterBEScreenHandler.this.inputSlot.takeStack(1);
                if (!itemStack.isEmpty()) {
                    StonecutterBEScreenHandler.this.populateResult();
                }

                context.run((world, pos) -> {
                    long l = world.getTime();
                    if (StonecutterBEScreenHandler.this.lastTakeTime != l) {
                        world.playSound((PlayerEntity)null, pos, SoundEvents.UI_STONECUTTER_TAKE_RESULT, SoundCategory.BLOCKS, 1.0F, 1.0F);
                        StonecutterBEScreenHandler.this.lastTakeTime = l;
                    }
            ...
            private List<ItemStack> getInputStacks() {
                return List.of(StonecutterBEScreenHandler.this.inputSlot.getStack());
            }
        });
    ...
    public boolean canUse(PlayerEntity player) {
        return canUse(this.context, player, BlockManager.STONE_CUTTER);
    }
