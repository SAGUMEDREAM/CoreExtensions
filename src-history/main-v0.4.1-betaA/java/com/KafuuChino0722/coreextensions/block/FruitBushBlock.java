...
implements Fertilizable {
    ...
    public FruitBushBlock(String namespace,String id,Settings settings) {
        super(settings);
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(IdentifierManager.getItem(namespace,id));
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            FruitBushBlock.dropStack(world, pos, new ItemStack(IdentifierManager.getItem(namespace,id), j + (bl ? 1 : 0)));
