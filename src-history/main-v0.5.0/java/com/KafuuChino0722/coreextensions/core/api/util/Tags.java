...
public class Tags {
    ...
    public static void generateMusicCD(String namespace, String id) {
        respacks.addTag(IdentifiedTagBuilder.createItem(ItemTags.MUSIC_DISCS).add(new Identifier(namespace, id)));
    }

    public static void generateFluid(Fluid STILL,Fluid FLOWING) {
        respacks.addTag(IdentifiedTagBuilder.createFluid(FluidTags.WATER).add(STILL).add(FLOWING));
    }
