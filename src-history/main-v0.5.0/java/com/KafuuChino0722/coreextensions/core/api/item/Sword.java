...
public class Sword {
    ...
    public static void register(String name, String namespace, String id, Map<String, Object> itemData, Map<String, Object> properties, String level, boolean generate){
        ...
        ToolItem Sword = registerSword(namespace, id, (double) attackDamage, (float) attackSpeed, durability, (ToolMaterials) material, rarityType, tooltipMsg);
    ...
    public static ToolItem registerSword(String namespace, String id, double attackDamage, float attackSpeed, int durability, ToolMaterials material, Rarity rarityType, String tooltipMsg) {
        return Registry.register(Registries.ITEM, new Identifier(namespace, id),
                new CustomSwordItem(material, (int) attackDamage, attackSpeed, new FabricItemSettings().maxDamage(durability).rarity(rarityType), tooltipMsg));
    }
