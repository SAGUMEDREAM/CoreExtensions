                                    ...
                                    if (Data != null && Data.containsKey("crops")) {
                                        ...
                                        for (Map.Entry<String, Object> itemEntry : blocks.entrySet()) {
                                            if (itemEntry.getValue() instanceof Map) {
                                                ...
                                                if(!Registries.BLOCK.containsId(new Identifier(namespace, id+"_block"))&&
                                                        !Registries.ITEM.containsId(new Identifier(namespace, id+"_age"))&&
                                                        !Registries.ITEM.containsId(new Identifier(namespace, id+"_seeds"))) {
                                                    ...
                                                    Info.custom(namespace+":"+id+" has been registered twice and has automatically prevented the game from crashing","CropBlockManager");
                                                }
