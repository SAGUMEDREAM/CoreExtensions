...
public class Shovel {
    ...
    public static void register(String name, String namespace, String id, Map<String, Object> itemData, String level, boolean generate){
        ...
        //ToolItem shovel =
        registerShovel(namespace, id, (double) attackDamage, (float) attackSpeed, durability, (ToolMaterials) material);
    ...
    public static ToolItem registerShovel(String namespace, String id, double attackDamage, float attackSpeed, int durability, ToolMaterials material) {
