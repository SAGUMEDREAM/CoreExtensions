...
import com.KafuuChino0722.coreextensions.core.registry.StorageRegistry;
import com.KafuuChino0722.coreextensions.loader.PluginReloadRegistryInject;
...
public class CommandCoreExtensions {
    ...
    public static class Command {
        ...
        public static int dumpRegistry(CommandContext<ServerCommandSource> context) {
            StorageRegistry.dumpAll();
            StorageRegistry.dumpAllCommand(context);
            ...
            if(Config.getConfigBoolean("ALLOW_RELOADING_REGISTRY")) {
                if(Reference.EnvType == EnvType.CLIENT) {
                    try {
                        ...
                        PluginReloadRegistryInject.Inject();
                    ...
                    PluginReloadRegistryInject.Inject();
                    try {
                        server.getCommandManager().executeWithPrefix(server.getCommandSource(), "coreextensions:reloaddp");
                    } catch (Exception e) {
                        context.getSource().sendFeedback(() -> Text.literal("ERROR?DATA PACKS").formatted(Formatting.RED), false);
                    }
                }
