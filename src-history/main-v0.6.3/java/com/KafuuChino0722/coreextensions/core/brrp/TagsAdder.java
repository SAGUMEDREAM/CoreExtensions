...
public class TagsAdder {
    public static void addTag() {
        ...
        respacks.addTag(TAG_GLASS_BLOCK);
        respacks.addTag(TAG_GLASS_ITEM);
        respacks.addTag(TAG_WOOL_CARPETS_BLOCK);
        respacks.addTag(TAG_WOOL_CARPETS_ITEM);
        ...
        respacks.addTag(TAG_TOOL);
        respacks.addTag(TAG_TOOL_PICKAXE);
        respacks.addTag(TAG_TOOL_AXE);
        respacks.addTag(TAG_TOOL_SWORD);
        respacks.addTag(TAG_TOOL_SHOVEL);
        respacks.addTag(TAG_TOOL_HOE);
        respacks.addTag(TAG_ARROWS);
        respacks.addTag(TAG_FOX_FOOD);
        ...
        respacks.addTag(TAG_VILlAGER_JOB_SITE);
    }
}
