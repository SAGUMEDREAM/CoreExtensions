        ...
        if (statusData != null && statusData.containsKey("effects")) {
            ...
            for (Map.Entry<String, Object> entry : status.entrySet()) {
                if (entry.getValue() instanceof Map) {
                    ...
                    if(net.minecraft.registry.Registries.STATUS_EFFECT.containsId(new Identifier(namespace, id))) {
                        StorageRegistry.add(StorageRegistry.STATUS_EFFECTS, new Identifier(namespace, id));
                    }
                }
            }
        }
