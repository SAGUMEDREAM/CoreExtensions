...
public class EventOnDeath implements EventInterface {
    public static void register(String namespace, String id, World world, PlayerEntity user, Hand hand) {
        ...
        load(namespace, id, wData, world, user, hand);
        Map<String, Map<String, Object>> wDataZ = IOFileManager.readZip(Events.EVENT);
        load(namespace, id, wDataZ, world, user, hand);
    }
                    ...
                    if (applyKey != null) {
                        for (String apply : applyKey) {
                            if (apply.equalsIgnoreCase(ItemIdentifier)) {
                                ...
                                if (actionsKey != null) {
                                    Map<String, Object> Key = (Map<String, Object>) actionsKey.getOrDefault("player_death", null);
                                    if (Key != null) {
