                ...
                if (entry.getValue() instanceof Map) {
                    ...
                    switch (types.toLowerCase()) {
                        ...
                        case "sapling" -> {
                            ...
                            Identifier configured_feature = new Identifier((String) properties.getOrDefault("configured_feature",namespace+":"+id));

                            RegistryKey<ConfiguredFeature<?, ?>> CUSTOM_TREE_KEY = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, configured_feature);
