...
public class CoreManager {
    ...
    public static final IdentifiedTagBuilder<Item> TAG_VILLAGER_PLANTABLE_SEEDS = IdentifiedTagBuilder.createItem(ItemTags.VILLAGER_PLANTABLE_SEEDS);
