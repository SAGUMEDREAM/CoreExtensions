...
public class CustomBlocks {
    ...
    public double blast_resistance = -1.0;
                    ...
                    if (blockKey.containsKey("break_tools_whitelist")) {
                        ...
                        for (String Line : break_tools_whitelist) {
                            ...
                            if(Line.contains("pickaxe")) {
                                IA_TAG_PICKAXE_MINEABLE.add(new Identifier(namespace,id));
                                blockSettings.requiresTool();
                            }
                            if(Line.contains("axe")) {
                                IA_TAG_AXE_MINEABLE.add(new Identifier(namespace,id));
                                blockSettings.requiresTool();
                            }
                            if(Line.contains("shovel")) {
                                IA_TAG_SHOVEL_MINEABLE.add(new Identifier(namespace,id));
                                blockSettings.requiresTool();
                            }
                            if(Line.contains("hoe")) {
                                IA_TAG_HOE_MINEABLE.add(new Identifier(namespace,id));
                                blockSettings.requiresTool();
                            }
                            if(Line.contains("shears")) {
                                IA_TAG_SHEARS_MINEABLE.add(new Identifier(namespace,id));
                                blockSettings.requiresTool();
                            }
