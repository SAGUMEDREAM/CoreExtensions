...
import static com.KafuuChino0722.coreextensions.CoreManager.TAG_FIRE_BLOCK;
...
public class Fire {
    ...
    public static void register(String name, String namespace, String id, int maxCount, Map<String, Object> blockData, Map<String, Object> properties, Boolean dropsNothing, BlockSoundGroup customSound ,double hardness, double resistance, boolean generate){
        ...
        try {
            ...
            Item BlockItem = Registry.register(Registries.ITEM, new Identifier(namespace, id), new BlockItem(block, new FabricItemSettings().maxCount(maxCount)));
        ...
        TAG_FIRE_BLOCK.add(new Identifier(namespace,id));
