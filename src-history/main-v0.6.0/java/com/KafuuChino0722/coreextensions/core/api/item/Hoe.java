...
import static com.KafuuChino0722.coreextensions.CoreManager.TAG_TOOL_HOE;
...
public class Hoe {
    ...
    public static void register(String name, String namespace, String id, Map<String, Object> itemData, Map<String, Object> properties, String level, boolean generate){
        ...
        ToolItem Hoe = new HoeItem(material, (int) attackDamage, (float) attackSpeed, ItemSettings) {
            @Override
