...
import static com.KafuuChino0722.coreextensions.CoreManager.TAG_TOOL_PICKAXE;
...
public class Axe {
    ...
    public static void register(String name, String namespace, String id, Map<String, Object> itemData, Map<String, Object> properties, String level, boolean generate){
        ...
        ToolItem Axe = new AxeItem(material, (float) attackDamage, (float) attackSpeed, ItemSettings) {
            @Override
        ...
        try {
            registerItem(namespace, id, Axe);
        } catch (Exception e) {
            setRegistry.set(namespace,id,Axe);
        }
    ...
    public static Item registerItem(String namespace, String id, ToolItem item) {
        return Registry.register(Registries.ITEM, new Identifier(namespace, id), item);
    }
}
