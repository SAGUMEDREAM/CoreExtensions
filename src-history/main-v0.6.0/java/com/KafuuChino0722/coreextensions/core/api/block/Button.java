...
import static com.KafuuChino0722.coreextensions.CoreManager.TAG_BUTTONS_BLOCK;
import static com.KafuuChino0722.coreextensions.CoreManager.TAG_BUTTONS_ITEM;
...
public class Button {
    public static void register(String name, String namespace, String id, int maxCount, Map<String, Object> blockData, Map<String, Object> properties, Boolean dropsNothing, BlockSoundGroup customSound ,double hardness, double resistance, boolean generate){
        boolean wooden = (boolean) properties.get("wooden");
        int pressTicks = (int) properties.get("pressTicks");
        ...
        if(generate) {
            Models.generate(namespace, id, "BUTTON");
        }
