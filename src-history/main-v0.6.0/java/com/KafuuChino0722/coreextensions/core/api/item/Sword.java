...
import static com.KafuuChino0722.coreextensions.CoreManager.TAG_TOOL_SWORD;
...
public class Sword {
    ...
    public static void register(String name, String namespace, String id, Map<String, Object> itemData, Map<String, Object> properties, String level, boolean generate){
        ...
        ToolItem Sword = new SwordItem(material, (int) attackDamage, (float) attackSpeed, ItemSettings) {
            @Override
