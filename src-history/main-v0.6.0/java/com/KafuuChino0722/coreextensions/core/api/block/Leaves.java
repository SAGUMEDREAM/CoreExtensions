...
import static com.KafuuChino0722.coreextensions.CoreManager.TAG_LEAVES_BLOCK;
import static com.KafuuChino0722.coreextensions.CoreManager.TAG_LEAVES_ITEM;
...
public class Leaves {
    public static void register(String name, String namespace, String id, int maxCount, Map<String, Object> blockData, Map<String, Object> properties, Boolean dropsNothing, BlockSoundGroup customSound ,double hardness, double resistance, boolean generate){
        FabricBlockSettings blockSettings = FabricBlockSettings.copyOf(Blocks.OAK_LEAVES)
        ...
        if(generate) {
            Models.generate(namespace, id, "LEAVES");
        }
