...
import com.KafuuChino0722.coreextensions.core.zip.block.*;
...
import com.KafuuChino0722.coreextensions.core.zip.item.*;
import com.KafuuChino0722.coreextensions.core.zip.world.iZipPortal;

public class iZipManager {
    public static void setup(boolean CORE_API_Enabled ,boolean bootstrap) {
        if(CORE_API_Enabled) {
            Info.custom("CoreManager Zip Loading!","ZipInputStream");
            ...
            if(bootstrap) {iZipmodifyGroups.load(paths);}
