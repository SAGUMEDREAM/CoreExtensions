...
import com.KafuuChino0722.coreextensions.item.CustomSnowballItem;
...
public class Ball {
    ...
    public static void register(String name, String namespace, String id, int maxCount, Map<String, Object> itemData, Map<String, Object> properties, boolean generate){
        ...
        Item item = new CustomSnowballItem(new Item.Settings().maxCount(maxCount).rarity(rarityType), tooltipMsg);
