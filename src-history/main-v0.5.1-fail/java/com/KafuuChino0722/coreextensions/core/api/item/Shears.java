...
import com.KafuuChino0722.coreextensions.item.CustomShearsItem;
...
public class Shears {
    ...
    public static void register(String name, String namespace, String id, Map<String, Object> itemData, Map<String, Object> properties, String level, boolean generate){
        ...
        ShearsItem Shears = registerShears(namespace, id, durability, rarityType, tooltipMsg);
    ...
    public static ShearsItem registerShears(String namespace, String id, int durability, Rarity rarityType, String tooltipMsg) {
        return Registry.register(Registries.ITEM, new Identifier(namespace, id),
                new CustomShearsItem(new FabricItemSettings().maxDamage(durability), tooltipMsg));
    }
}
