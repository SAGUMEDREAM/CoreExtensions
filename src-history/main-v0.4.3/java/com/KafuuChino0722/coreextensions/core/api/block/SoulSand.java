...
public class SoulSand {
    ...
    public static void register(String name, String namespace, String id, int maxCount, Map<String, Object> blockData, Map<String, Object> properties, Boolean dropsNothing, BlockSoundGroup customSound ,double hardness, double resistance, boolean generate){
        ...
        respacks.addTag(IdentifiedTagBuilder.createBlock(BlockTags.SOUL_SPEED_BLOCKS).add(new Identifier(namespace,id)));
        respacks.addTag(IdentifiedTagBuilder.createBlock(BlockTags.SOUL_FIRE_BASE_BLOCKS).add(new Identifier(namespace,id)));
        respacks.addTag(IdentifiedTagBuilder.createBlock(BlockTags.WITHER_SUMMON_BASE_BLOCKS).add(new Identifier(namespace,id)));
