package com.KafuuChino0722.coreextensions.core.oldapi_v2;
...
/*
                                        if (Objects.equals(types, "cube_all") || Objects.equals(types, "CUBE_ALL") || Objects.equals(types, "CUBEALL")) {
                                            CubeALL.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);

                                        } else if (Objects.equals(types, "cube") || Objects.equals(types, "CUBE")) {
                                            Cube.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);

                                        } else if (Objects.equals(types, "button") || Objects.equals(types, "BUTTON")) {
                                            Button.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);

                                        } else if (Objects.equals(types, "door") || Objects.equals(types, "DOOR")) {
                                            Door.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);

                                        } else if (Objects.equals(types, "fence") || Objects.equals(types, "FENCE")) {
                                            Fence.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);
                                            ...
                                            FenceGate.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);
                                            ...
                                            PressurePlate.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);

                                        } else if (Objects.equals(types, "slab") || Objects.equals(types, "SLAB")) {
                                            Slab.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);

                                        } else if (Objects.equals(types, "stairs") || Objects.equals(types, "STAIRS")) {
                                            Stairs.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);

                                        } else if (Objects.equals(types, "trapdoor") || Objects.equals(types, "TRAPDOOR")) {
                                            TrapDoor.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);

                                        } else if (Objects.equals(types, "wall") || Objects.equals(types, "WALL")) {
                                            Wall.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);

                                        } else if (Objects.equals(types, "sand") || Objects.equals(types, "SAND") || Objects.equals(types, "FallingBlock")) {
                                            Sand.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);
                                            ...
                                            SoulSand.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);

                                        } else if (Objects.equals(types, "fire") || Objects.equals(types, "FIRE")) {
                                            Fire.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);

                                        } else if (Objects.equals(types, "log") || Objects.equals(types, "LOG")) {
                                            CubeLog.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);

                                        } else if (Objects.equals(types, "leaves") || Objects.equals(types, "LEAVES")) {
                                            Leaves.register(name, namespace, id, blockData, dropsNothing, customSound, hardness, resistance, generate);
