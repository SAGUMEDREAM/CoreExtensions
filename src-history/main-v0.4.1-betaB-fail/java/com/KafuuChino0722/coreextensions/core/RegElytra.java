                                ...
                                for (Map.Entry<String, Object> entry : items.entrySet()) {
                                    if (entry.getValue() instanceof Map) {
                                        ...
                                        if (generate) {
                                            ...
                                            respacks.addLang(new Identifier(namespace+"_"+id, "en_us"), LanguageProvider.create()
                                                    .add("item."+namespace+"."+id, lang_us));
                                            respacks.addLang(new Identifier(namespace+"_"+id, "zh_cn"), LanguageProvider.create()
