...
public class RegStairsBlock {
    ...
    public static void load() {
        ...
        try {
            Map<String, Map<String, Object>> blocksData = yaml.load(new FileReader(FILE + "blockStairs.yml"));
            ...
            if (blocksData != null && blocksData.containsKey("blocks")) {
                ...
                for (Map.Entry<String, Object> entry : blocks.entrySet()) {
                    if (entry.getValue() instanceof Map) {
                        ...
                        //Block parent = (String) blockData.get("parent");
                        String parent = (String) blockData.get("parent");
