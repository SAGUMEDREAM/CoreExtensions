...
public class RecipeJson {
    public static void generate(String name,
        ...
        if (Objects.equals(types, "crafting_shaped") || Objects.equals(types, "CRAFTING_SHAPED") || Objects.equals(types, "craftingshaped") || Objects.equals(types, "CRAFTINGSHAPED")) {
            ...
            String topRowPattern = pattern.containsKey("topRowPattern") ? (String) pattern.get("topRowPattern") : "ABC";
            String middleRowPattern = pattern.containsKey("middleRowPattern") ? (String) pattern.get("middleRowPattern") : "DEF";
            String bottomRowPattern = pattern.containsKey("bottomRowPattern") ? (String) pattern.get("bottomRowPattern") : "GHI";
            //Info.create(topRowPattern);Info.create(middleRowPattern);Info.create(bottomRowPattern);

            CraftingShaped.generate(name,namespace,id,types,SizeX,SizeY,topRowPattern,middleRowPattern,bottomRowPattern,A,B,C,D,E,F,G,H,I,result,maxCount,categoryType,categoryTypeCrafting);
            ...
            CraftingShapeless.generate(name,namespace,id,types,A,B,C,D,E,F,G,H,I,result,maxCount,categoryType,categoryTypeCrafting);
