...
public class CoreManager {
    ...
    public static final RuntimeResourcePack respacks = RuntimeResourcePack.create(new Identifier("mce", "packs"));
    public static final RuntimeResourcePack datapacks = RuntimeResourcePack.create(new Identifier("mce", "datapacks"));
    ...
    public static void load() {
        ...
        try {
            ...
            if (CORE_API_Enabled) {
                ...
                RRPCallback callback = new RRPCallback() {
                    @Override
                    public void insert(List<ResourcePack> resources) {
                        ...
                        CoreRegReload.load();
                        ZipManager.load();*/
                        resources.add(respacks);
                    }
                };
                RRPCallback.BEFORE_VANILLA.register(callback);
