...
public class EventPlayerBreakingBlockRegistry implements EventInterface {
                    ...
                    if (applyKey != null) {
                        for (String apply : applyKey) {
                            if (apply.equalsIgnoreCase(ItemIdentifier)) {
                                ...
                                if (actionsKey != null) {
                                    Map<String, Object> Key = (Map<String, Object>) actionsKey.getOrDefault("breaking_block", null);
                                    if (Key != null) {
