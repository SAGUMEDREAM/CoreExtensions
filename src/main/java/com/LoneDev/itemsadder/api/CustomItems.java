...
public class CustomItems {
    ...
    public static boolean isFuel = false;
    public static int burn_ticks;
    ...
    public static String musicSoundName;
    public static String musicDescription;
    ...
    public static int FurLightLevel = 0;
    public static boolean FurSolid;
    public static boolean FurSmall;
                    ...
                    for (Map.Entry<String, Object> itemEntry : items.entrySet()) {
                        ...
                        if(enabled) {
                            ...
                            if(types.equalsIgnoreCase("arrow")) {
                                ...
                                IaPacks.addTag(IdentifiedTagBuilder.createItem(ItemTags.ARROWS).add(new Identifier(namespace,id)));
                                IaLanguageProvider.add("item." +namespace +"."+id, display_name);
                            }
                                                ...
                                                for (Map.Entry<String, Object> entry : resultKey.entrySet()) {
                                                    if (entry.getValue() instanceof Map) {
                                                        ...
                                                        if(key.containsKey("item")) {
                                                            ...
                                                            IaPacks.addLootTable(Registries.BLOCK.get(new Identifier(namespace, id+"_block_"+lootItem)).getLootTableId(),
                                                                    new VanillaBlockLootTableGenerator().cropDrops(
                                                                            ...
                                                                            Registries.ITEM.get(new Identifier(namespace, id+"_seeds")),
