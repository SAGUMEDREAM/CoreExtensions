...
public class Loots {
    ...
    public static void CROP(String namespace, String id, Map<String, Object> blockData, Map<String, Object> properties) {
...
*/
        ...
        NEED(namespace, id, blockData, properties);
        LEVEL(namespace, id, blockData, properties);
    }

    public static void ONLY(String namespace, String id, Map<String, Object> blockData, Map<String, Object> properties) {
    ...
    public static void LEVEL(String namespace, String id, Map<String, Object> blockData, Map<String, Object> properties) {
        ...
        public static void NEED(String namespace, String id, Map<String, Object> blockData, Map<String, Object> properties) {
