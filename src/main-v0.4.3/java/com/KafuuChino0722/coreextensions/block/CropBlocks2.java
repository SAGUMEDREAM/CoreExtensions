...
public class CropBlocks2
    ...
    public CropBlocks2(Settings settings, String namespace, String id) {
        super(settings);
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        float f;
        int i;
        if (world.getBaseLightLevel(pos, 0) >= 9 && (i = this.getAge(state)) < this.getMaxAge() && random.nextInt((int)(25.0f / (f = CropBlocks2.getAvailableMoisture(this, world, pos))) + 1) == 0) {
