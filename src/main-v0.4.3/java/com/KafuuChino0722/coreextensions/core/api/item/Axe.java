...
public class Axe {
    ...
    public static void register(String name, String namespace, String id, Map<String, Object> itemData, Map<String, Object> properties, String level, boolean generate){
        ...
        ToolItem Axe = registerAxe(namespace, id, (float) attackDamage, (float) attackSpeed, durability, (ToolMaterials) material, rarityType);
    ...
    public static ToolItem registerAxe(String namespace, String id, float attackDamage, float attackSpeed, int durability, ToolMaterials material, Rarity rarityType) {
