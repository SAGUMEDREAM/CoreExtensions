...
public class Pickaxe {
    ...
    public static void register(String name, String namespace, String id, Map<String, Object> itemData, Map<String, Object> properties , String level, boolean generate){
        ...
        //ToolItem pickaxe =
        ToolItem Pickaxe = registerPickaxe(namespace, id, (int) attackDamage, (float) attackSpeed, durability, (ToolMaterials) material, rarityType);
    ...
    public static ToolItem registerPickaxe(String namespace, String id, int attackDamage, float attackSpeed, int durability, ToolMaterials material, Rarity rarityType) {
