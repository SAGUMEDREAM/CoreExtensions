                    ...
                    for (File zipFile : zipFiles) {
                        try (ZipFile zip = new ZipFile(zipFile)) {
                            ...
                            while (entries.hasMoreElements()) {
                                ...
                                if (!entry.isDirectory() && entry.getName().equals("data/lootTables@Overwrite.yml")) {
                                        ...
                                        if (Data != null && Data.containsKey("loots")) {
                                            ...
                                            for (Map.Entry<String, Object> DataEntry : blocks.entrySet()) {
                                                if (DataEntry.getValue() instanceof Map) {
                                                    ...
                                                    String pathV = (String) LootTablesData.get("path");
                                                    ...
                                                    modifyLootTables.create(namespace, pathV, item, chance, count);

                                                    ReturnMessage.LootsYMLRegister(name, namespace, pathV, item);
