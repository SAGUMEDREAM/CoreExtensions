...
public class RegHoe {
    ...
    public static void load() {
        ...
        try {
            Map<String, Map<String, Object>> ValueData = yaml.load(new FileReader(FILE + "hoe.yml"));

            if (ValueData != null && ValueData.containsKey("hoes")) {
                Map<String, Object> swords = ValueData.get("hoes");
                ...
                for (Map.Entry<String, Object> entry : swords.entrySet()) {
                    if (entry.getValue() instanceof Map) {
                        ...
                        ToolItem hoe = register(namespace, id, (double) attackDamage, (float) attackSpeed, durability, (ToolMaterials) material);
                    }
                }
            }
        } catch (IOException e) {
