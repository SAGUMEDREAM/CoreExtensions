...
public class Axe {
    ...
    public static void register(String name, String namespace, String id, Map<String, Object> itemData, String level, boolean generate){
        ...
        //ToolItem axe =
        registerAxe(namespace, id, (float) attackDamage, (float) attackSpeed, durability, (ToolMaterials) material);
    ...
    public static ToolItem registerAxe(String namespace, String id, float attackDamage, float attackSpeed, int durability, ToolMaterials material) {
